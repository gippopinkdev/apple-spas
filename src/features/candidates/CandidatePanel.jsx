...
function Dove() {
    return (
        <svg className="dove-placeholder" viewBox="0 0 240 180" aria-hidden="true">
            <path
...
export default function CandidatePanel({
    ...
    return (
        <div className="candidate-panel-root">
            ...
            >
                <button className="candidate-panel-close" onClick={onClose} aria-label="Close">
                    <CloseIcon />
                </button>
        ...
        <>
            <div className="candidate-top">
                ...
                <div className="candidate-header">
                    ...
                    <div className="candidate-title">
                        ...
                        <div className="candidate-district">Округ №{district}</div>

                        <div className="candidate-region">{region}</div>

                        {party && (
                            <div className="candidate-party">
                                <span className="party-mark">Я</span>
                                {party}
                            </div>
                        )}
                    </div>
            ...
            <div className="candidate-body">
                ...
                <Section title="Ссылки">
                    <SocialLinks socials={socials} website={website} />
                </Section>
...
function EmptyDistrictContent({ district }) {
    return (
        <div className="empty-district">
            <div className="candidate-badge">Пока без кандидата</div>
            ...
            <div className="empty-district-content">
                ...
                <p>
                    Поддержите партию за мир, чтобы больше
    ...
    return (
        <div className="social-links">
            <div className="social-icons">
                ...
                {website && (
                    <a href={website} target="_blank" rel="noreferrer" className="candidate-website">
                        <GlobeIcon />
...
function SupportApple() {
    return (
        <section className="support-apple">
            <div className="support-apple-title">Поддержать партию за мир</div>
